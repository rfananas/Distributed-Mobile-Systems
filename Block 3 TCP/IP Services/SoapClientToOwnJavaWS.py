...
client = zeep.Client(wsdl='http://10.192.100.97:8080/04_a_Webservice_Simple/FirstWebServiceService?wsdl')
...
print('calcCircleArea(5)  :', client.service.calcCircleArea(10))